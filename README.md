...
*   **Fuentes de Información:** searXena actúa como un agregador de señales públicas. Valoramos y respetamos la labor de indexación realizada por los motores de búsqueda externos (Google, Bing, DuckDuckGo, etc.). searXena consulta sus fuentes públicas para consolidar resultados, actuando como una interfaz independiente de visualización y anonimización de datos públicos, sin afiliación, respaldo ni relación comercial con dichos proveedores.
