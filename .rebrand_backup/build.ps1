...
${_BCyan}searXena Windows Build Script${_creset}
${_Green}=========================${_creset}
...
function Invoke-Check {
    ...
    $static = Join-Path $REPO_ROOT "searxena\static\themes\simple\sxng-core.min.js"
    if (Test-Path $static) {
        Write-Host "${_Green}OK${_creset}"
    } else {
...
function Invoke-Install {
    ...
    if (Test-Path $setup) {
        ...
        Write-Status "Instalando searXena..."
