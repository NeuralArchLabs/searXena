...
data.all() {
    (
        ...
        pyenv.cmd python searxena_extra/update/update_osm_keys_tags.py
        build_msg DATA "update searx/data/ahmia_blacklist.txt"
        python searxena_extra/update/update_ahmia_blacklist.py
        build_msg DATA "update searx/data/wikidata_units.json"
        python searxena_extra/update/update_wikidata_units.py
        build_msg DATA "update searx/data/currencies.json"
        python searxena_extra/update/update_currencies.py
        build_msg DATA "update searx/data/external_bangs.json"
        python searxena_extra/update/update_external_bangs.py
        build_msg DATA "update searx/data/engine_descriptions.json"
        python searxena_extra/update/update_engine_descriptions.py
    )
}
...
data.traits() {
    (
        ...
        python searxena_extra/update/update_engine_traits.py
...
data.useragents() {
    ...
    pyenv.cmd python searxena_extra/update/update_firefox_version.py
    dump_return $?
}

data.gsa_useragents() {
    build_msg DATA "update searx/data/gsa_useragents.txt"
    pyenv.cmd python searxena_extra/update/update_gsa_useragents.py
    dump_return $?
}
...
data.locales() {
    (
        ...
        python searxena_extra/update/update_locales.py
    )
    dump_return $?
}
