...
=======================
Reemplaza referencias de SearXNG por searXena de forma inteligente,
...
REPLACEMENTS: List[Tuple[str, str, str]] = [
    ...
    (r'SearX NG', 'searXena', 'SearX NG → searXena'),
    (r'Searx NG', 'searXena', 'Searx NG → searXena'),
    
    # Nombres de paquete/modulo
    (r'searxng_extra', 'searxena_extra', 'modulo searxng_extra'),
    (r'searxng\.', 'searxena.', 'searxng. → searxena.'),
...
def main():
    parser = argparse.ArgumentParser(
        description='searXena Rebranding Tool - Reemplaza SearXNG por searXena'
    )
    parser.add_argument(
        '--dry-run', '-n',
        action='store_true',
