...
class TestUtils(SearxTestCase):
    ...
    def test_searxena_useragent(self):
        self.assertIsInstance(utils.searxena_useragent(), str)
        self.assertIsNotNone(utils.searxena_useragent())
        self.assertTrue(utils.searxena_useragent().startswith('SearXNG'))
