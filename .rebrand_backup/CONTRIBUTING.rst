...
.. _Quickstart guide: https://docs.searXena.org/dev/quickstart.html
.. _Commits guide: https://docs.searXena.org/dev/commits.html
.. _Weblate: https://translate.codeberg.org/projects/searXena/searXena/
.. _GitHub Codespaces: https://docs.github.com/en/codespaces/overview
.. _120 hours per month: https://github.com/settings/billing
.. _list of existing Codespaces: https://github.com/codespaces

Thank you for your interest in searXena.

Have a look at our `Quickstart guide`_, it's very easy to contribute.

Further information on *how-to* can be found
`here <https://docs.searXena.org/dev/index.html>`_.

Translations
============

Help translate searXena at `Weblate`_.

.. image:: https://translate.codeberg.org/widget/searXena/searXena/horizontal-auto.svg
   :target: https://translate.codeberg.org/engage/searXena/
   :alt: Weblate
   :width: 768px
...
- You can start searXena using ``make run`` in the terminal or by pressing ``Ctrl+Shift+B``.
...
not your character or personality. Keep in mind we all want to make searXena
better.
