...
The script :origin:`searxena_extra/update/update_engine_traits.py` is called in
...
# SPDX-License-Identifier: AGPL-3.0-or-later
'''List of searXena's locale codes used for the search language/region.
...
0. searXena's internal locale tag (a language or region tag)
...
4. Unicode flag (emoji) that fits to searXena's internal region tag. Languages
