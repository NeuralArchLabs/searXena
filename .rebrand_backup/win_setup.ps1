...
# searXena Windows Setup - Instalador one-shot
...
# 6. Instalar searXena en modo desarrollo
Step "Instalando searXena en modo desarrollo..."
Set-Location $REPO_ROOT
& $PY_EXE -m pip install --use-pep517 --no-build-isolation -e ".[test]"
Ok "searXena instalado"
...
O manualmente:
  ...
  granian --interface wsgi --host 127.0.0.1 --port 8888 searxena.webapp:app
