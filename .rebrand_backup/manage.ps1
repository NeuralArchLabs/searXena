...
# searXena - Windows Native Management Script
...
function Invoke-PyEnvInstall {
    ...
    Write-Build "PYENV" "[install] granian[reload,pname]"
    & $PY_EXE -m pip install "granian[reload,pname]"
    Write-Build "PYENV" "OK"
}

function Invoke-PyEnvUninstall {
    Write-Build "PYENV" "[uninstall] searXena"
    & $PY_EXE -m pip uninstall -y searXena
}
...
function Start-Webapp {
    ...
    Write-Build "WEBAPP" "iniciando searXena en http://127.0.0.1:8888/"
    ...
    # $env:GRANIAN_RELOAD_PATHS = ".\searxena"
    ...
    Enter-PyEnv
    & $GRANIAN_EXE searxena.webapp:app
}
...
${_BCyan}searXena Windows Management Script${_creset}
${_BGreen}=================================${_creset}
